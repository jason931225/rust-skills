...
![rules](https://img.shields.io/badge/rules-434-blue)
...
434 Rust rules your AI coding agent can use to write better code. Current for Rust 1.97.1 (2024 edition).
...
434 rules split into 27 categories:

| Category | Rules | What it covers |
|----------|-------|----------------|
| **Ownership & Borrowing** | 14 | When to borrow vs clone, Arc/Rc, lifetimes |
...
| **Concurrency** | 12 | rayon, scoped threads, atomic ordering, thread-locals |
...
| **Serde** | 11 | rename_all, default, flatten, enum tagging, validate-on-deserialize |
