...
![rules](https://img.shields.io/badge/rules-279-blue)
...
279 Rust rules your AI coding agent can use to write better code. Current for Rust 1.96 (2024 edition).
...
279 rules split into 27 categories:
