...
![rules](https://img.shields.io/badge/rules-398-blue)
...
398 Rust rules your AI coding agent can use to write better code. Current for Rust 1.97.1 (2024 edition).
...
398 rules split into 27 categories:
...
| **Unsafe Code** | 13 | `SAFETY:` comments, Miri, `MaybeUninit`, 2024-edition unsafe |
| **API Design** | 50 | Builder pattern, newtypes, sealed traits, `FromIterator` |
...
| **Type Safety** | 23 | Newtypes, parse don't validate, `Deref`, `Display`/`Debug` |
...
| **Project Structure** | 33 | Workspaces, module layout, features, MSRV |
