...
![rules](https://img.shields.io/badge/rules-427-blue)
...
427 Rust rules your AI coding agent can use to write better code. Current for Rust 1.97.1 (2024 edition).
...
427 rules split into 27 categories:
